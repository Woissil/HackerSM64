COURSE_ACTS(COURSE_BOB, _(" 1 CRYSTAL REALM"),
       _("HITTING THE TARGETS")     , _("SHATTERING THE CRYSTAL") , _("CLIMBING THE PLATFORMS"),
       _("GUESS THE PLATFORM")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_JRB, _(" 3 PLANT REALM"),
       _("KILL ALL THE ZOMBIES")    , _("CAN THE EEL COME OUT TO PLAY?") , _("TREASURE OF THE OCEAN CAVE"),
