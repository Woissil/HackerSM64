COURSE_ACTS(COURSE_BOB, _(" 1 Retro World"),
       _("TOP OF THE FLAGPOLE")     , _("ABOVE THE CLOUDS") , _("MUSHROOMS CLIMBING"),
       _("RETRO RED COINS")          , _("UNDERGROUND PARKOUR")        , _("THE UNDERGROUND GRID -VC-"))

COURSE_ACTS(COURSE_WF, _(" 2 SKY HIGH JUNGLE"),
       _("GET UP THE GIANT VINE")        , _("TO THE END OF THE CAVE")    , _("TO THE TOP OF THE FLOATING ISLAND"),
       _("INSIDE THE WINDMILL"), _("SHELL RIDE ON THE TOXIC POISON")    , _("RED COINS ACROSS THE JUNGLE"))
...
COURSE_ACTS(COURSE_CCM, _(" 4 CHRISTMAS SNOW PEAKS"),
       _("SCALING THE SNOWY MOUNTAIN")             , _("SANTA'S GIFT")             , _("FROSTY RED COINS"),
       _("SLIDING SECRET")  , _("THE LOST PENGUIN")       , _("WINDY JOURNEY"))
...
SECRET_STAR(COURSE_BITFS, _("   BOWSER'S POISONOUS FACTORY"))
