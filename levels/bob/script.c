...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, -1466, 505, -2432, 0, -90, 0, (4 << 24), bhvBowserCourseRedCoinStar),
		...
		OBJECT(MODEL_RED_COIN, -6479, 892, 1423, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -2590, 515, 4425, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -4974, 201, -7537, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -605, 1054, 1918, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -605, 1054, 1918, 0, 0, 0, 0x00000000, bhvRedCoin),
