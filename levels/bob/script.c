...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 1692, 630, 2072, 0, 0, 0, (1 << 16), bhvExclamationBox),
		OBJECT(MODEL_YELLOW_COIN, -158, 201, -37, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -100, 201, -37, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -41, 201, -37, 0, 0, 0, 0x00000000, bhvYellowCoin),
