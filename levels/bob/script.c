...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_FALLING_OBJECT, 7916, 6649, -356, 0, 0, 0, (120 << 24) | (2 << 16) | (2 << 8), bhvFallingObject),
		OBJECT(MODEL_FALLING_OBJECT, 7305, 7002, -1143, 0, 0, 0, (120 << 24) | (2 << 16) | (2 << 8), bhvFallingObject),
