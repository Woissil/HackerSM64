...
const GeoLayout bob_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -4226, 250, 1383, 74, 63, 119, bob_dl__009_geometry_005_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -3804, 100, 5113, 0, -180, 0, bob_dl_Cube_007_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
