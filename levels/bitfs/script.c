...
const LevelScript level_bitfs_entry[] = {
	...
	AREA(1, bitfs_area_1),
		...
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, 4370, 7561, -158, 0, -180, 0, (30 << 24) | (15 << 16) | (3 << 8) | (1), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, 4821, 7888, -712, 0, 0, 0, (30 << 24) | (15 << 16) | (3 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, 4370, 7716, -1723, 0, -180, 0, (30 << 24) | (15 << 16) | (3 << 8) | (1), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, 4829, 7716, -2560, 0, 0, 0, (30 << 24) | (15 << 16) | (3 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, -5033, 5625, -110, 0, -90, 0, (30 << 24) | (15 << 16) | (1 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, -6306, 5625, -618, 0, 90, 0, (30 << 24) | (15 << 16) | (1 << 8) | (1), bhvInOutPlatform),
		OBJECT(0, 6722, 8645, -6340, 0, 0, 0, (0xA1 << 16), bhvAirborneDeathWarp),
		...
		OBJECT(MODEL_NOTEBLOCK, -3944, 4072, -1375, 0, 0, 0, (57 << 16), bhvNoteBlock),
		...
		OBJECT(MODEL_WARP_PIPE, 6706, 8285, -6821, 0, 0, 0, (0xA2 << 16), bhvWarpPipe),
