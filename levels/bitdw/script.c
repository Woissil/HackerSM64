...
const LevelScript level_bitdw_entry[] = {
	...
	AREA(1, bitdw_area_1),
		...
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, 4552, 7561, -158, 0, -180, 0, (30 << 24) | (15 << 16) | (1 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, 4821, 7888, -712, 0, 0, 0, (30 << 24) | (15 << 16) | (1 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, 4552, 7716, -1723, 0, -180, 0, (30 << 24) | (15 << 16) | (1 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, 4777, 7716, -2560, 0, 0, 0, (30 << 24) | (15 << 16) | (1 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, -5033, 5625, -159, 0, -90, 0, (30 << 24) | (15 << 16) | (1 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, -6306, 5625, 188, 0, 90, 0, (30 << 24) | (15 << 16) | (1 << 8), bhvInOutPlatform),
