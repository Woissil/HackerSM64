...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		MARIO_POS(0x01, 0, 3, 326, -253),
		OBJECT(MODEL_SPIN_FLOWER, -2564, 829, 4014, 0, 0, 0, (84 << 16), bhvSpinFlower),
		OBJECT(MODEL_SPIN_FLOWER, 1786, 270, -2625, 0, 0, 0, (90 << 16), bhvSpinFlower),
		OBJECT(MODEL_STAR, 9303, 5082, -3541, 0, 0, 0, (3 << 16), bhvStar),
		OBJECT(MODEL_VINE, -1176, 928, -688, 0, 0, 0, (90 << 16), bhvVine),
		OBJECT(MODEL_NONE, 3, 326, -253, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 6283, 2415, 4676, 0, 0, 0, (3 << 16), bhvExclamationBox),
