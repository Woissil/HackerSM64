...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NOTEBLOCK, 1402, 366, 1266, 0, 0, 0, (80 << 16), bhvNoteBlock),
		...
		OBJECT(MODEL_SWITCHBLOCK_SWITCH_MOP, 859, 366, 109, 0, 0, 0, 0x00000000, bhvSwitchblock_Switch_MOP),
