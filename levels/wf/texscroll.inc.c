...
void scroll_wf_dl_Circle_010_mesh_layer_1_vtx_5() {
	int i = 0;
	int count = 32;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Circle_010_mesh_layer_1_vtx_5);
...
void scroll_wf_dl_Circle_051_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 127;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Circle_051_mesh_layer_5_vtx_0);
...
void scroll_wf_dl_Circle_051_mesh_layer_5_vtx_1() {
	int i = 0;
	int count = 114;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Circle_051_mesh_layer_5_vtx_1);

	deltaY = (int)(0.3400000035762787 * 0x20) % height;
...
void scroll_wf() {
	...
	scroll_wf_dl_Circle_010_mesh_layer_1_vtx_5();
	...
	scroll_wf_dl_Circle_051_mesh_layer_5_vtx_0();
	scroll_wf_dl_Circle_051_mesh_layer_5_vtx_1();
};
