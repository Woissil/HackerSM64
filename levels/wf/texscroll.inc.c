...
void scroll_wf_dl_Circle_040_mesh_layer_6_vtx_0() {
	int i = 0;
	int count = 22;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(wf_dl_Circle_040_mesh_layer_6_vtx_0);
...
void scroll_wf() {
	...
	scroll_wf_dl_Circle_040_mesh_layer_6_vtx_0();
};
