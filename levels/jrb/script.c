...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_GOOMBA, -7, 349, -1562, 0, 0, 0, 0x000A0000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 1248, 349, -2029, 0, 0, 0, 0x000A0000, bhvGoomba),
		MARIO_POS(0x01, 0, -7, 612, -33),
		OBJECT(MODEL_STAR, 4867, 1863, -14652, 0, 0, 0, 0x000A0000, bhvStar),
		OBJECT(MODEL_NONE, -7, 612, -33, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_GOOMBA, 476, 349, -3108, 0, 0, 0, 0x000A0000, bhvGoomba),
