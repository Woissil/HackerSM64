...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_CHUCKYA, -3554, 263, 3942, 0, 0, 0, 0, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4846, 264, 3942, 0, 0, 0, 0, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -4193, 264, 3482, 0, 0, 0, 0, bhvChuckya),
		...
		OBJECT(MODEL_NONE, -4324, 263, 3942, 0, 0, 0, 0, bhvChuckyaStarSpawner),
