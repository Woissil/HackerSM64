...
const LevelScript level_bowser_1_entry[] = {
	...
	AREA(1, bowser_1_area_1),
		...
		WARP_NODE(0xF1, LEVEL_BITFS, 0x01, 0xA1, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, -647, 2870, 5051, 0, 0, 0, (30 << 24) | (15 << 16) | (3 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, -1127, 2870, 6418, 0, 0, 0, (30 << 24) | (15 << 16) | (3 << 8) | (1), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, -647, 3118, 6875, 0, 0, 0, (30 << 24) | (15 << 16) | (3 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BITDW_IN_OUT_PLATFORM, 150, 3093, 9975, 0, -90, 0, (30 << 24) | (15 << 16) | (1 << 8), bhvInOutPlatform),
		OBJECT(MODEL_BULLY_BOSS, 780, 2457, 1429, 0, 0, 0,  0x0, bhvBigBully),
		...
		OBJECT(MODEL_NONE, 998, 1984, 1145, 0, 0, 0, (1 << 16) | (1 << 8), bhvSwitchblock_MOP),
		OBJECT(MODEL_NONE, 998, 1055, 1145, 0, 0, 0, (0 << 16) | (1 << 8), bhvSwitchblock_MOP),
		OBJECT(MODEL_NONE, 998, 122, 1145, 0, 0, 0, (1 << 16) | (1 << 8), bhvSwitchblock_MOP),
		OBJECT(MODEL_NONE, 3252, 4631, 1190, 0, 0, 0, (1 << 16) | (1 << 8), bhvSwitchblock_Switch_MOP),
		OBJECT(MODEL_NONE, -557, 3715, 9346, 0, 0, 0, (1 << 8), bhvSwitchblock_Switch_MOP),
		OBJECT(MODEL_SWITCHBLOCK_SWITCH_MOP, -1730, 2573, -4630, 0, 0, 0, (1 << 8), bhvSwitchblock_Switch_MOP),
		...
		SET_BACKGROUND_MUSIC(0x2A, SEQ_DMG_B1),
