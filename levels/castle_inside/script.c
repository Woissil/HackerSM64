...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(0x08, LEVEL_BITFS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xD2, LEVEL_ENDING, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_CASTLE_KEY_DOOR, 90, 991, 2071, 0, -180, 0, (2 << 24) | (0xD3 << 16), bhvDoorWarp),
		OBJECT(MODEL_CASTLE_KEY_DOOR, -58, 991, 2071, 0, 0, 0, (2 << 24) | (0xD2 << 16), bhvDoorWarp),
