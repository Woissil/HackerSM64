...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(0, 328, 710, -1921, 0, 0, 0, 0x00000000, bhvAirborneDeathWarp),
		OBJECT(0, -1620, 1540, 30, 0, -90, 0, 0x00000000, bhvAirborneDeathWarp),
		OBJECT(0, -12, 1450, 1775, 0, -180, 0, 0x00000000, bhvAirborneDeathWarp),
		OBJECT(0, 989, 1290, 5, 0, 90, 0, 0x00000000, bhvAirborneDeathWarp),
		OBJECT(0, 328, 710, -1921, 0, 0, 0, 0x00000000, bhvAirborneStarCollectWarp),
		OBJECT(0, -1620, 1540, 30, 0, -90, 0, 0x00000000, bhvAirborneStarCollectWarp),
		OBJECT(34, -1235, 1000, 75, 0, 90, 0,  0x14000000, bhvDoor),
		OBJECT(34, -1235, 1000, -73, 0, -90, 0,  0x14000000, bhvDoor),
		...
		OBJECT(MODEL_NOTEBLOCK, -9, 60, 1209, 0, 0, 0,  0x280000, bhvNoteBlock),
		OBJECT(0, 2222, 690, -29, 0, -90, 0, 0x00000000, bhvSpinAirborneWarp),
		OBJECT(221, 928, 200, -2334, 0, 0, 0,  0x4c000000, bhvToadMessage),
		OBJECT(0, 351, 610, -2968, 0, 0, 0, 0x00000000, bhvWarp),
		OBJECT(MODEL_WARP_PIPE, -2150, 1128, 0, 0, 0, 0, 0x00000000, bhvWarpPipe),
