...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(0, -350, 630, 1125, 0, 0, 0, 0x00000000, bhvAirborneDeathWarp),
		...
		OBJECT(38, -600, 827, 5830, 0, -180, 0, (5 << 16), bhvDoorWarp),
		OBJECT(38, -750, 827, 5830, 0, 0, 0, (4 << 16), bhvDoorWarp),
