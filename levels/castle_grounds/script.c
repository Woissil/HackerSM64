...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		WARP_NODE(0xC2, LEVEL_CCM, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(0, 4499, 1156, 6192, 0, 0, 0, (0xC1 << 16), bhvAirborneDeathWarp),
		...
		OBJECT(0, 4499, 1156, 6192, 0, 0, 0, (0xC0 << 16), bhvAirborneStarCollectWarp),
		...
		OBJECT(22, -3307, 1795, -693, 0, 0, 0, (1 << 16), bhvWarpPipe),
		OBJECT(22, 5119, 736, 6333, 0, 0, 0, (0xC2 << 16), bhvWarpPipe),
