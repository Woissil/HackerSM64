...
const GeoLayout ccm_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -8123, 0, 0, 90, 0, 0, ccm_dl_c4_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, ccm_dl_c4_mesh_layer_4),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_c4_mesh_layer_5),
		GEO_CLOSE_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, -8123, 0, 0, 90, 0, 0, ccm_dl_c4_005_mesh_layer_4),
...
const GeoLayout ccm_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, -565, 0, -1134, -565, -100, -1134, geo_camera_main),
				GEO_OPEN_NODE(),
