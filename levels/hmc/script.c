...
const LevelScript level_hmc_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_CATAQUACK, cataquack_geo), 
	...
	LOAD_MODEL_FROM_GEO(MODEL_PIANTA, pianta_geo), 
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_CATAQUACK, 602, 250, 10634, 0, 47, 0, 0x00000000, bhvCataquack),
		OBJECT(MODEL_CATAQUACK, -314, 250, 9827, 0, 0, 0, 0x00000000, bhvCataquack),
		OBJECT(MODEL_CATAQUACK, 3372, 485, 4342, 0, 0, 0, (1 << 16), bhvCataquack),
		...
		OBJECT(MODEL_NONE, 5001, 86, 10403, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 10523, 390, -10735, 0, 0, 0, (25 << 16), bhvDeathWarp),
		...
		OBJECT(MODEL_RED_COIN, 5380, 838, 9873, 0, 0, 0, 0x00000000, bhvRedCoin),
	...
	AREA(2, hmc_area_2),
		...
		WARP_NODE(0xF0, LEVEL_CASTLE, 0x01, 0x32, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BARREL, -753, 135, 11085, 0, 0, 0, (2 << 16), bhvBeachBarrel),
	...
	AREA(3, hmc_area_3),
		WARP_NODE(0x0A, LEVEL_HMC, 0x01, 21, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_CASTLE, 0x01, 0x32, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_HMC, 0x01, 25, WARP_NO_CHECKPOINT),
	...
	AREA(4, hmc_area_4),
		...
		OBJECT(MODEL_CATAQUACK, -7313, 462, -4832, 0, 0, 0, (5 << 24), bhvCataquack),
		OBJECT(MODEL_CATAQUACK, -7313, 462, -4045, 0, -45, 0, (5 << 24), bhvCataquack),
		OBJECT(MODEL_NONE, 35, 314, -48, 0, 0, 0, (10 << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_STAR, -15320, 550, -1696, 0, 0, 0, (5 << 24), bhvStar),
