...
void scroll_hmc_dl_Plane_004_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 25;
	int width = 32 * 0x20;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(hmc_dl_Plane_004_mesh_layer_5_vtx_0);
...
void scroll_hmc_dl_Plane_006_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 25;
	int width = 32 * 0x20;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(hmc_dl_Plane_006_mesh_layer_5_vtx_0);
...
void scroll_hmc() {
	...
	scroll_hmc_dl_Plane_004_mesh_layer_5_vtx_0();
	scroll_hmc_dl_Plane_006_mesh_layer_5_vtx_0();
};
