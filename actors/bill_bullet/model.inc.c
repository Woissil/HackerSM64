...
// 0x0500BAA8
ALIGNED8 static const Texture bill_bullet_seg5_texture_0500BAA8[] = {
#include "actors/bill_bullet/bill_bullet_eye.rgba16.inc.c"
};

// 0x0500CAA8
ALIGNED8 static const Texture bill_bullet_seg5_texture_0500CAA8[] = {
#include "actors/bill_bullet/bill_bullet_mouth.rgba16.inc.c"
};

// 0x0500DAA8
static const Vtx bill_bullet_seg5_vertex_0500DAA8[] = {
...
// 0x0500DB98
static const Vtx bill_bullet_seg5_vertex_0500DB98[] = {
...
// 0x0500DC28
static const Vtx bill_bullet_seg5_vertex_0500DC28[] = {
...
// 0x0500DD18
static const Vtx bill_bullet_seg5_vertex_0500DD18[] = {
    {{{   -70,     71,    347}, 0, {   508,   -448}, {0xf0, 0x15, 0x7c, 0xff}}},
...
// 0x0500DE08
static const Vtx bill_bullet_seg5_vertex_0500DE08[] = {
    {{{   -70,    -70,    347}, 0, {   508,    384}, {0xd9, 0xe3, 0x74, 0xff}}},
...
// 0x0500DEC8
static const Vtx bill_bullet_seg5_vertex_0500DEC8[] = {
...
// 0x0500DFB8
static const Vtx bill_bullet_seg5_vertex_0500DFB8[] = {
...
// 0x0500E0A8
static const Vtx bill_bullet_seg5_vertex_0500E0A8[] = {
    {{{     0,   -249,   -192}, 0, {     0,      0}, {0xf0, 0x8a, 0xd6, 0xff}}},
    {{{     0,   -249,    161}, 0, {     0,      0}, {0x10, 0x86, 0x1c, 0xff}}},
    {{{  -176,   -176,    161}, 0, {     0,      0}, {0xb6, 0x9e, 0x1c, 0xff}}},
    {{{     0,   -249,   -192}, 0, {     0,      0}, {0xf0, 0x8a, 0xd6, 0xff}}},
...
// 0x0500E198
static const Vtx bill_bullet_seg5_vertex_0500E198[] = {
    {{{   177,    177,   -192}, 0, {     0,      0}, {0x52, 0x3e, 0xb7, 0xff}}},
...
// 0x0500E288
static const Vtx bill_bullet_seg5_vertex_0500E288[] = {
    {{{     0,    196,    272}, 0, {     0,      0}, {0x02, 0x62, 0x50, 0xff}}},
...
// 0x0500E378
static const Vtx bill_bullet_seg5_vertex_0500E378[] = {
    {{{  -138,    139,    272}, 0, {     0,      0}, {0xbc, 0x47, 0x50, 0xff}}},
    {{{     0,    196,    272}, 0, {     0,      0}, {0x02, 0x62, 0x50, 0xff}}},
    {{{     0,    250,    161}, 0, {     0,      0}, {0xef, 0x7a, 0x1c, 0xff}}},
    {{{  -176,    177,   -192}, 0, {     0,      0}, {0xc2, 0x52, 0xb7, 0xff}}},
...
// 0x0500E468
static const Vtx bill_bullet_seg5_vertex_0500E468[] = {
    {{{  -176,   -176,   -192}, 0, {     0,      0}, {0xd6, 0xe0, 0x8d, 0xff}}},
    {{{  -249,      0,    161}, 0, {     0,      0}, {0x86, 0xef, 0x1c, 0xff}}},
    {{{  -249,      0,   -192}, 0, {     0,      0}, {0x8a, 0x10, 0xd6, 0xff}}},
...
// 0x0500E558
static const Vtx bill_bullet_seg5_vertex_0500E558[] = {
...
const Gfx bill_bullet_seg5_dl_0500E5E8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bill_bullet_seg5_texture_0500BAA8),
    gsDPTileSync(),
    ...
    gsSPVertex(bill_bullet_seg5_vertex_0500DAA8, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(bill_bullet_seg5_vertex_0500DB98, 9, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx bill_bullet_seg5_dl_0500E678[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bill_bullet_seg5_texture_0500CAA8),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(bill_bullet_seg5_vertex_0500DC28, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(bill_bullet_seg5_vertex_0500DD18, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(bill_bullet_seg5_vertex_0500DE08, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSPEndDisplayList(),
};
...
const Gfx bill_bullet_seg5_dl_0500E730[] = {
    gsSPVertex(bill_bullet_seg5_vertex_0500DEC8, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(bill_bullet_seg5_vertex_0500DFB8, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(bill_bullet_seg5_vertex_0500E0A8, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(bill_bullet_seg5_vertex_0500E198, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(bill_bullet_seg5_vertex_0500E288, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(bill_bullet_seg5_vertex_0500E378, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(bill_bullet_seg5_vertex_0500E468, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(bill_bullet_seg5_vertex_0500E558, 9, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP1Triangle( 6,  7,  8, 0x0),
    gsSPEndDisplayList(),
};
...
const Gfx bill_bullet_seg5_dl_0500E8A8[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(bill_bullet_seg5_dl_0500E5E8),
    gsSPDisplayList(bill_bullet_seg5_dl_0500E678),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPDisplayList(bill_bullet_seg5_dl_0500E730),
    gsSPEndDisplayList(),
};
